...
const Card1 = () => {
  ...
  return (
    <div
      className={cn(
        "px-10 py-9 bg-neutral-800 space-y-4 rounded-2xl hover:translate-x-2 hover:-translate-y-2 transition-transform translate-x-0 translate-y-0 after:absolute after:inset-0 after:translate-z-[-4px,_4px,_-1px] after:bg-gradient-to-b after:from-blue-500 after:to-green-500 after:rounded-2xl after:transition-all after:opacity-0 hover:after:opacity-100 after:z-[3] shrink-0",
